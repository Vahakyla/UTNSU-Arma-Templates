	...
	case "MARK": {
		...
		for "_i" from 1 to 2 do {_unit addItemToVest "NFCW_M61SmokeGrenade";};
		for "_i" from 1 to 2 do {_unit addItemToVest "NFCW_M43Grenade";};
		for "_i" from 1 to 10 do {_unit addItemToVest "CUP_10Rnd_762x54_SVD_M";};
		...
		_unit addPrimaryWeaponItem "CUP_10Rnd_762x54_SVD_M";
	...
	case "SLAT": {
		...
		_unit addWeapon _rifle;
		_unit addPrimaryWeaponItem "NFCW_30Rnd_762x39_RK62_Mag";
		_unit addWeapon "CUP_launch_APILAS";
		_unit addWeapon "Binocular";
	...
	case "TCOM": {
		...
		for "_i" from 1 to 2 do {_unit addItemToVest "NFCW_M61SmokeGrenade";};
		for "_i" from 1 to 2 do {_unit addItemToVest "NFCW_M43Grenade";};
		for "_i" from 1 to 6 do {_unit addItemToVest "NFCW_14Rnd_9x19_PIST_80_Mag";};
		_unit addHeadgear "H_NFCW_FIN_TSH4M2_Open";
	...
	case "CONVOYRADIO": {
		...
		comment "Lorry Driver with Radio";
		comment "Add containers";
		_unit forceAddUniform _uniform;
		for "_i" from 1 to 4 do {_unit addItemToUniform "ACE_epinephrine";};
		for "_i" from 1 to 6 do {_unit addItemToUniform "ACE_morphine";};
