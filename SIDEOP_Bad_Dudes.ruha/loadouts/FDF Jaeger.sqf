	...
	case "OFF": {
		...
		comment "Add weapons";
		_unit addWeapon "NFCW_762_RK_62_mid_grip";
	...
	case "PL": {
		...
		_unit addPrimaryWeaponItem "CUP_optic_ACOG2";
		_unit addPrimaryWeaponItem "NFCW_30Rnd_762x39_RK62_Mag";
		_unit addWeapon "Binocular";
	...
	case "AAR": {
		...
		_unit addBackpack "Flex_CUP_FIN_Kitbag";
		_unit addItemToBackpack "ACE_EntrenchingTool";
		for "_i" from 1 to 4 do {_unit addItemToBackpack "CUP_100Rnd_TE4_LRT4_762x54_PK_Tracer_Red_M";};
		_unit addHeadgear _helmet;
